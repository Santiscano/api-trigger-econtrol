...
class ClearhistryModel {
  getpedidosNumeracionPagadosModel = async () => {
    const [query] = await connection.query(
      "SELECT CONSECUTIVO FROM TB_NUMERACIONES_COMPROBANTES_GENERADOS WHERE ESTADO =5 AND TOTAL_ABONO > 0 AND  HISTORICOS = 1 LIMIT 80"
    );
    return query;
  };
